                                                        ...
                                                        <div>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li v-for="result in searchResults" :key="result.name">
                                                                    {{ result.category }} <span style="color: red;" v-if="result.percentage_amt">[{{ result.percentage_amt }}%]</span>
                                                            ...
                                                            <ul>
                                                                <li v-for="(item, index) in showProCategories" :key="index"> <span>{{ item }} </span>
                                                                    <button type="button" @click="removeCategory(item)">
...
const productrow = () => {
    ...
    axios.get(`/dropshippingpro/productrow/${product_id}`).then(response => {
        // console.log("=====" + response.data.product.description_short);
