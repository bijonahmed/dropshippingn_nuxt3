				...
				<form class="" @submit.prevent="login()">
					...
					<div class="form-group">
						...
						<input class="form-control" type="password" id="password" placeholder="Enter Password"
							v-model="password" style="margin-top: 5px;" />
							...
							<div class="row">
								<div class="col">
									<div id="CaptchaImageCode" class="CaptchaTxtField bgCanvas">
										...
										<input type="hidden" id="UserCaptchaCode"
											class="CaptchaTxtField form-control mt-2" v-model="captchaInput"
											@input="validateCaptcha">
									</div>
								</div>
								<div class="col">
									<button type="button" class="btn btn-primary" @click="createCaptcha"><i
